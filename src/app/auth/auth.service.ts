...
export class AuthService {
  ...
  createUser(formData: any) {
    ...
    this.http.post('http://http://13.68.181.244:3000/api/farmers/signup', formData)
      .subscribe(response => {
  ...
  login(contactNumber: string, password: string) {
    ...
    this.http.post<{ token: string, expiresIn: number, userId: string }>('http://http://13.68.181.244:3000/api/farmers/login', authData)
      .subscribe(response => {
